...
import { CustomSliderStyles } from "./CustomSlider.styles";

interface CustomSliderProps extends Partial<SliderProps> {
  sliderVal: number;
...
const CustomSlider: React.FC<CustomSliderProps> = ({
  ...
  return (
    <Slider
      ...
      containerStyle={CustomSliderStyles.container}
      thumbStyle={CustomSliderStyles.thumb}
      trackStyle={CustomSliderStyles.track}
      {...props}
    />
  );
};
